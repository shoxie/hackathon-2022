    ...
    <div className="max-w-screen-xl px-5 mx-auto lg:px-0">
      ...
      <div className="flex items-center justify-center pt-10">
        <button className="flex items-center space-x-3 general-button">
          ...
          <button type="button" className="text-2xl" onClick={handleAddToPlan}>Thêm vào kế hoạch</button>
        </button>
      </div>
      <div className="py-10">
        <div>
      ...
      <div>
        <CommentSection isSection isProfilePage={false} data={reviews} locationName={detail?.name ?? ""} />
      </div>
    </div>
  );
};
